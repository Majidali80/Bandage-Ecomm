        ...
        <section className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {['Clothes', 'Electronics', 'Shoes', 'Accessories', 'Home'].map((category, index) => (
            <div key={index} className="relative p-4 rounded shadow">
              <img
                src={`/${index + 1}.png`} // Dynamic image source based on index
                alt={category}
                className="rounded"
              />
      ...
      <section className="bg-[#fafafa] py-10">
        <div className="max-w-screen-xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-6 mr-36">
            ...
            <img
              src="/fbft.png" // Replace with the correct path to your image
              alt="Facebook"
              className="w-6 h-6"
            />
            <img
              src="/insft.png" // Replace with the correct path to your image
              alt="Instagram"
              className="w-6 h-6"
            />
            <img
              src="/twft.png" // Replace with the correct path to your image
              alt="Twitter"
              className="w-6 h-6"
            />
          </div>
