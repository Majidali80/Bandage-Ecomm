          ...
          <div className="w-[788px] h-[180px] px-10 py-16">
            ...
            <div className="flex justify-center items-center mt-5 gap-4">
              ...
              <div className="rounded-l-[16px] border-t-[1px] border-l-0 border-r-0 border-b-0 border-[#23A6F0] bg-white">
                <img src="/pr1.png" alt="description" className="w-full h-full object-contain" />
              </div>
              <h5 className="font-Montserrat text-[16px] font-bold leading-[24px] tracking-[0.1px] text-left text-[#252B42]">
                Yearly
              </h5>
              <button className="bg-[#B2E3FF] text-[#23A6F0] px-6 py-2 rounded-xl hover:bg-blue-300">
                <span className="text-sm text-green-500 ml-2">Save 8%</span>
              </button>
            </div>
{/* Made By Majid Ali */}
            {/* Pricing Cards */}
