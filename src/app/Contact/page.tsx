              ...
              <div className="w-[200px] h-[50px] mt-5 ">
                ...
                <div className="flex items-center justify-center gap-5 w-full">
                  ...
                  <div className="w-[30px] h-[24.49px] p-[0.02px]">
                    <img src="/co7.png" alt="Twitter" className="w-full h-full object-contain" />
                  </div>
                  
                  {/* Facebook Icon */}
                  <div className="w-[30px] h-[24.49px] p-[0.02px]">
                    <img src="/co8.png" alt="Facebook" className="w-full h-full object-contain" />
                  </div>
                  
                  {/* Instagram Icon */}
                  <div className="w-[30px] h-[24.49px] p-[0.02px]">
                    <img src="/co10.png" alt="Instagram" className="w-full h-full object-contain" />
                  </div>
                  
                  {/* LinkedIn Icon */}
                  <div className="w-[30px] h-[24.49px] p-[0.02px]">
                    <img src="/co11.png" alt="LinkedIn" className="w-full h-full object-contain" />
                  </div>
                </div>
              </div>
 {/* Made By Majid Ali */}
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6">
            ...
            <div className="w-80 bg-white border border-gray-200 p-6 rounded-lg text-center">
              <div className="text-blue-500 mb-4 justify-center">
                <img
                  src="/co3.png"  // Replace with the actual image path
                  alt="Shop Image"
            ...
            <div className="w-[328px] h-[403px] p-[50px] gap-[15px] bg-[#252B42] ">
              <div className="mb-10 flex justify-center">
                <img
                  src="/co4.png"  // Replace with the actual image path
                  alt="Shop Image"
 ...
 {/* Made By Majid Ali */}
            ...
            <div className="w-80 bg-white border border-gray-200 p-6 rounded-lg text-center">
              <div className="text-blue-500 mb-4">
                <img
                  src="/co5.png"  // Replace with the actual image path
                  alt="Shop Image"
          ...
          <div className="text-center mt-24">
            <div className="w-[72.56px] h-[30px] ml-[500px] border-t-[4px] rotate-[-5.56deg]  ">
              <img
                src="/co6.png"  // Replace with the actual image path
                alt="Shop Image"
                className="w-[72px] h-[55px] ml-24 "  // Adjust the size or remove grayscale if needed
              />
            </div>
