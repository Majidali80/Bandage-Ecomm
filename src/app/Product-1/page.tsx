...
import Greentopheader from "../components/Greentopheader/page";
import CardsText from "../components/cards-text/page";
    ...
    <div>
      ...
      <div className="w-[1280px] h-[92px] py-[24px] bg-[#FAFAFA]">
        <div className="w-[1230px] h-[44px] absolute left-[130px] flex gap-[30px]">
          <div className="flex items-center gap-[15px]">
            ...
            <Image src="/v1.png" alt="arrow" width={8} height={6} />
      ...
      <div className=" min-w-[1280px] container top-[200px] py-12 flex flex-col md:flex-row gap-8 font-Montserrat bg-[#FAFAFA]">
        ...
        <div className="flex-1">
          <div className="relative ml-20">
            <Image src="/Sofa.jpg" alt="Product Image" className="rounded-lg" width={600} height={400} />
             {/* Arrows */}
          ...
          <div className="flex mt-4 gap-4">
             <Image src="/tn1.jpg" alt="Thumbnail 1" className="ml-20 rounded-md cursor-pointer hover:ring-2 hover:ring-blue-500" width={100} height={100} onClick={() => handleThumbnailClick("/assets/single-product-1-thumb-1.jpg")} />
             <Image src="/tn2.jpg" alt="Thumbnail 2" className="rounded-md cursor-pointer hover:ring-2 hover:ring-blue-500" width={100} height={100} onClick={() => handleThumbnailClick("/assets/single-product-1-thumb-2.jpg")} />
          </div>
        </div>
        ...
        <div className="flex-1 mt-6">
          ...
          <div className=" flex items-center gap-4 mt-20">
            ...
            <div className="flex items-center gap-4">
              <Image src="/v4.png" alt="heart" width={24} height={24} className="cursor-pointer" />
              <Image src="/v3.png" alt="cart" width={24} height={24} className="cursor-pointer" />
              <Image src="/v2.png" alt="eye" width={24} height={24} className="cursor-pointer" />
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Product Cards */}
        ...
        <div className="w-full lg:w-[323px] h-auto flex-shrink-0 rounded-lg overflow-hidden">
          <Image src="/v5.png" alt="Interior Design" width={332} height={392} className="object-cover" />
        </div>
    ...
    <div className="flex flex-col justify-center">
      <div>
        ...
        <ul className="mt-2 space-y-4 text-[#737373] font-Montserrat font-bold text-[14px] leading-[20px]">
          <li className="flex items-center gap-2"><Image src="/v1.png" alt="Arrow" width={12} height={12} /> the quick fox jumps over the lazy dog</li>
          <li className="flex items-center gap-2"><Image src="/v1.png" alt="Arrow" width={12} height={12} /> the quick fox jumps over the lazy dog</li>
          <li className="flex items-center gap-2"><Image src="/v1.png" alt="Arrow" width={12} height={12} /> the quick fox jumps over the lazy dog</li>
          <li className="flex items-center gap-2"><Image src="/v1.png" alt="Arrow" width={12} height={12} /> the quick fox jumps over the lazy dog</li>
...
<div className="w-[1340px] h-[1250px] px-[195px] py-0 bg-[#FAFAFA]">
  <div className="w-[924px] h-[1086px] left-[195px] px-0 py-[20px] gap-[10px]">
    ...
    <div className="w-[238px] h-auto bg-white shadow-lg">
      <img src="/b1.png" alt="Product Image" className="w-[239px] h-[280px] object-cover" />
    ...
    {/* Box 2 */}
    <div className="w-[238px] h-auto bg-white shadow-lg">
      <img src="/b2.png" alt="Product Image" className="w-[239px] h-[280px] object-cover" />
      <div className="flex justify-center w-full h-auto p-[20px] pb-[30px] gap-[10px]">
        {/* Importing cards-text.tsx component */}
        <CardsText />
      </div>
    ...
    {/* Box 3 */}
    <div className="w-[238px] h-auto bg-white shadow-lg">
      <img src="/b3.png" alt="Product Image" className="w-[239px] h-[280px] object-cover" />
      <div className="flex justify-center w-full h-auto p-[20px] pb-[30px] gap-[10px]">
        {/* Importing cards-text.tsx component */}
        <CardsText />
      </div>
    ...
    {/* Box 4 */}
    <div className="w-[238px] h-auto bg-white shadow-lg">
      <img src="/b4.png" alt="Product Image" className="w-[239px] h-[280px] object-cover" />
      <div className="flex justify-center w-full h-auto p-[20px] pb-[30px] gap-[10px]">
        {/* Importing cards-text.tsx component */}
        <CardsText />
      </div>
    ...
    {/* Box 5 */}
    <div className="w-[238px] h-auto bg-white shadow-lg">
      <img src="/b5.png" alt="Product Image" className="w-[239px] h-[280px] object-cover" />
      <div className="flex justify-center w-full h-auto p-[20px] pb-[30px] gap-[10px]">
        {/* Importing cards-text.tsx component */}
        <CardsText />
      </div>
    ...
    {/* Box 6 */}
    <div className="w-[238px] h-auto bg-white shadow-lg">
      <img src="/b6.png" alt="Product Image" className="w-[239px] h-[280px] object-cover" />
      <div className="flex justify-center w-full h-auto p-[20px] pb-[30px] gap-[10px]">
        {/* Importing cards-text.tsx component */}
        <CardsText />
      </div>
    ...
    {/* Box 7 */}
    <div className="w-[238px] h-auto bg-white shadow-lg">
      <img src="/b01.png" alt="Product Image" className="w-[239px] h-[280px] object-cover" />
      <div className="flex justify-center w-full h-auto p-[20px] pb-[30px] gap-[10px]">
        {/* Importing cards-text.tsx component */}
        <CardsText />
      </div>
 ...
 {/* Logo Grid */}
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8 bg-[#fafafa]">
              <div className="flex justify-center ml-32">
                <Image src="/ab7.png" alt="Client 1 Logo" className="h-10 w-auto" width={48} height={48} />
              </div>
              <div className="flex justify-center ml-20">
                <Image src="/ab8.png" alt="Client 2 Logo" className="h-10 w-auto" width={48} height={48} />
              </div>
              <div className="flex justify-center ml-20">
                <Image src="/ab9.png" alt="Client 3 Logo" className="h-10 w-auto" width={48} height={48} />
              </div>
              <div className="flex justify-center ml-20">
                <Image src="/ab10.png" alt="Client 4 Logo" className="h-10 w-auto" width={48} height={48} />
              </div>
              <div className="flex justify-center mr-20">
                <Image src="/ab11.png" alt="Client 5 Logo" className="h-10 w-auto" width={48} height={48} />
              </div>
              <div className="flex justify-center mr-28">
                <Image src="/ab12.png" alt="Client 6 Logo" className="h-10 w-auto" width={48} height={48} />
              </div>
            </div>
    <Footer />
   </div>
